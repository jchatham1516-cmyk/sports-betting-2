...
def build_feature_row_from_teams(home_team_name, away_team_name, stats_dfteam_stats_df):
    ...
    row  {
        ...
        "Δ_eFG":  home_stats["eFG"]  - away_stats["eFG"],
        "Δ_TOV":  away_stats["TOV"]  - home_stats["TOV"],
        "Δ_AST":  home_stats["AST"]  - away_stats["AST"],
        "Δ_ORB":  home_stats["ORB"]  - away_stats["ORB"],
        "Δ_DRB":  home_stats["DRB"]  - away_stats["DRB"],
        "Δ_FTAr": home_stats["FTAr"] - away_stats["FTAr"],
    }
